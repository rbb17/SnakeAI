...
class Agent():
    ...
    def __init__(self):
        ...
        self.memory  = deque(maxlen=MAX_MEMORY)  # popleft if more than memory
    ...
    def get_state(self,game):
        ...
        point_u = Point(head.x, head.y - 20)    # negative is up
        point_d = Point(head.x, head.y + 20)   # Positive is down
    ...
    def remember(self,state,action,reward,next_state,done):
        self.memory.append((state,action,reward,next_state,done)) # popleft id MAX_MEMORY is reached
